...
// tipi di sinistri
  ...
  constructor(public service:ServiziService, public fb:FormBuilder,public dialogRef: MatDialogRef<ServiziComponent>,private toast:ToastService) {
...
if(this.checkedList.length === 1){
  ...
  console.log(this.service.serviziFiltered)
    ...
    this.service.serviziFiltered = this.service.serviziFiltered.reduce((arr:Service[],item:Service)=>{
      ...
      if(
      (type1 === item.tipo_sinistro || type2 === item.tipo_sinistro)){
